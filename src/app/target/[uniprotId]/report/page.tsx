    ...
    <AnimatedLayout>
      <main className="min-h-screen p-6">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            <div className="ml-auto flex gap-2">
              ...
              <a
                ...
                className="rounded-lg bg-emerald-500 px-5 py-2 text-sm font-medium text-white hover:bg-emerald-600 active:scale-[0.97] transition-all"
              >
                Download PDF
              </a>
            </div>
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <h1 className="text-3xl font-bold text-foreground">{report.target.name}</h1>
              ...
              <div className={`rounded-full px-5 py-2 text-sm font-bold ring-1 ${vc.bg} ${vc.text} ${vc.ring}`}>
          ...
          {/* Verdict section */}
          <div className="mb-8 grid gap-6 md:grid-cols-[180px_1fr]">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="glass-panel rounded-lg p-4 text-center">
                  <div className="text-2xl font-bold text-foreground">{report.pockets.length}</div>
                  <div className="text-xs text-muted">Pockets</div>
                </div>
                <div className="glass-panel rounded-lg p-4 text-center">
                  <div className="text-2xl font-bold text-foreground">{ls.total_known}</div>
                  <div className="text-xs text-muted">Known ligands</div>
                </div>
                <div className="glass-panel rounded-lg p-4 text-center">
                  <div className="text-2xl font-bold text-foreground">{ls.approved_drugs}</div>
                  <div className="text-xs text-muted">Approved drugs</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {pocketData.length > 0 && (
            <div className="mb-8 rounded-lg border border-border bg-surface p-6">
              <h2 className="mb-4 text-lg font-semibold text-foreground">Pocket Analysis</h2>
          ...
          <div className="mb-8 grid gap-6 md:grid-cols-2">
            ...
            {pieData.length > 0 && (
              <div className="rounded-lg border border-border bg-surface p-6">
                <h2 className="mb-4 text-lg font-semibold text-foreground">Clinical Phase Distribution</h2>
            ...
            <div className="rounded-lg border border-border bg-surface p-6">
              <h2 className="mb-4 text-lg font-semibold text-foreground">Ligand Summary</h2>
          ...
          {report.top_ligands.length > 0 && (
            <div className="mb-8 rounded-lg border border-border bg-surface p-6">
              <h2 className="mb-4 text-lg font-semibold text-foreground">Top Ligands by Activity</h2>
